...
(function (window, oCpf) {
	 ...
	 * //TODO: @property в JSDoc предназначен немного не для этого, что свойства параметра лучше описывать с указанием
	 * параметра, к которому они относятся:
	 * // @param {function} [oPrototype._Init] функция, вызываемая при конструировании экземпляра
